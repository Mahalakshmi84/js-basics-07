...
//object will always ba inside {} and properties will be defined as key/value pair
// ex: key: value
//use the dot operator to access one property of a object
//key should be camelcase, and it should be a one word
let employee = {
    name: 'Shan', //string
    age: 12, //number
